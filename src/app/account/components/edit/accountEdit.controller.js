				...
				if (allStations[idx].operating_country === allCountries[idx1].id) {
					...
					for (idx2=0; idx2 < managePermission.length; idx2++) {
						if (managePermission[idx2].country === null && managePermission[idx2].station === null) {
							toDisable = false;
							break;
						} else if (managePermission[idx2].country === allCountries[idx1].id) {
							toDisable = false;
						} else if (managePermission[idx2].station === allStations[idx].id) {
							toDisable = false;
						}
					}
        ...
        for (idx=0; idx < allCountries.length; idx++) {
			...
			for (idx2=0; idx2 < managePermission.length; idx2++) {
				if (managePermission[idx2].country === null && managePermission[idx2].station === null) {
					toDisable = false;
					break;
				} else if (managePermission[idx2].country === allCountries[idx].id) {
					toDisable = false;
				}
			}
