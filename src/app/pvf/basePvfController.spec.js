import {BasePvfController} from "./basePvfController";
...
class PvfTestController extends BasePvfController {
    constructor($scope, $uibModal, constants, PvfService, $stateParams, $state) {
        'ngInject';        
        super($scope, $uibModal, constants, PvfService, $stateParams, $state);
...
describe('PvfTestController', () => {
    ...
    beforeEach(() => {
        ...
        let PvfService = {
            ...
            submitPvf: (countryId, id, response) => ({
                then: () => { }
            }),
        ...
        let $state = {go: () => {}};
        vm = new PvfTestController($scope, $uibModal, {}, PvfService, $stateParams, $state, IdConstants);
    });
