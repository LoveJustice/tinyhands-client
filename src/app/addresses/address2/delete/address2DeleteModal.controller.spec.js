import Address2DeleteModalController from './address2DeleteModal.controller';

describe('Address2DeleteModalController', () => {
    let vm,
        state,
        uibModalInstance,
        mockToastr,
    ...
    beforeEach(inject((_$q_, _$rootScope_) => {
        ...
        vm = new Address2DeleteModalController(uibModalInstance, address, $scope, mockAdreess1Service, state, mockToastr);
    ...
    describe('- function cancel - ', () => {
        it('should go to address2 list without any stateParams', () => {
            vm.cancel();
            expect(state.go).toHaveBeenCalledWith('address2', {deleteId: null}, {notify: false});
        });
    ...
    describe('- function delete - ', () => {
        ...
        it('on success it should go to address2 without state params', () => {
            vm.confirm = true;
            vm.delete(address);
            $rootScope.$apply();

            expect(vm.state.go).toHaveBeenCalledWith('address2', {deleteId: null});
        });
