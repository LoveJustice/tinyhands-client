...
export class IrfUsaController extends BaseIrfBlindVerificationController {
    constructor($scope, $uibModal, constants, IrfService, $stateParams, $state, SpinnerOverlayService, $uibModalStack, SessionService) {
        ...
        this.destinationQuestions = ["destinationLabel",245.0, 245.1, 245.2];
        this.purposeQuestions = ["purposeLabel",924.1, 924.2,924.3,924.4, 924.5,924.6,924.7];
        this.vulnerabilityQuestions = ["vulnerableLabel",1084,1073,502,925,78,942,926,280,974,1083,1079,978,988];
