...
export class IrfTanzaniaController extends BaseIrfBlindVerificationController {
    constructor($scope, $uibModal, constants, IrfService, $stateParams, $state, SpinnerOverlayService, $uibModalStack, SessionService) {
        ...
        this.vulnerabilityQuestions = ["vulnerableLabel",1084,1073,502,925,78,942,926,280,974,1083,277,251];
        ...
        this.details = {
            ...
            924.6:{
                enabled:true,
                group:924,
                label:'Livestock keeping',
                value:'Livestock keeping',
                type:'checkbox-group',
                format:'col-md-4',
                points:0
            },
        ...
        this.contactList = [['Police','Shopkeeper','Taxi driver'],['Other NGO','Hotel Owner','Subcommittee'],['Machinga','Social Worker','Street vendor','Bus Driver','Immigration']];
