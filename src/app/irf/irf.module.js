...
export default angular.module('tinyhands.IRF', [IrfIndiaModule, IrfNepalModule, IrfSouthAfricaModule, IrfBangladeshModule, IrfMalawiModule, IrfAfricaModule, IrfBeninModule, sharedModule])
    .config(IrfRoutes)
