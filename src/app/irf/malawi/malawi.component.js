...
export class IrfMalawiController extends BaseIrfController {
    constructor($scope, $uibModal, constants, IrfService, $stateParams, $state, SpinnerOverlayService) {
        ...
        this.vulnerabilityQuestions = ["vulnerableLabel",246,502,925,78,942,926,280,"metLabel",242,244];
        ...
        this.details = {
            ...
            924.5:{
                enabled:true,
                group:924,
                label:'2.10 Cattle Herding',
                value:'Cattle Herding',
                type:'checkbox-group',
                format:'col-md-4',
                points:0
            },
