...
import CifSouthAfricaModule from './southAfrica/cif.southAfrica.module';
...
export default angular.module('tinyhands.CIF', [CifNepalModule, CifIndiaModule, CifBangladeshModule, CifSouthAfricaModule, sharedModule])
    .config(CifRoutes)
