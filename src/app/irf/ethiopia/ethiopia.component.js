    ...
    constructor($scope, $uibModal, constants, IrfService, $stateParams, $state, SpinnerOverlayService, $uibModalStack, SessionService) {
        ...
        this.details = {
            ...
            968.5:{
                enabled:true,
                group:968,
                label:'Conflict-vulnerable ethnic groups',
                value:'Conflict-vulnerable ethnic groups',
                type:'checkbox-group',
                format:'col-md-3',
                points:0
            },
            968.6:{
                enabled:true,
                group:968,
                label:'Smuggled migrant',
                value:'Smuggled migrant',
                type:'checkbox-group',
                format:'col-md-3',
                points:0
            },
            968.7:{
                enabled:true,
                group:968,
                label:'Recently returned migrant',
                value:'Recently returned migrant',
                type:'checkbox-group',
                format:'col-md-3',
                points:0
            },
             968.8:{
                enabled:true,
                group:968,
                label:'No or fraudulent ID cards',
                value:'No or fraudulent ID cards',
                type:'checkbox-group',
                format:'col-md-3',
                points:0
            },
            ...
            245.7:{
                enabled:true,
                group:245,
                label:"Addis Ababa central market",
                value:"Addis Ababa central market",
                type:'checkbox-group',
                format:'col-md-6',
                points:0
            },
            ...
            974:{
                enabled:true,
                label:'First time travelling abroad',
                type:'checkbox',
                format:'col-md-12',
                points:0
            },
...
export default {
    templateUrl,
    controller: IrfEthiopiaController,
};
