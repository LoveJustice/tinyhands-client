const VdfOtherData = require('../otherData.js');
const VdfDateDate = require('../dateData.js');

export class BaseVdfController {
    ...
    setValuesForOtherInputs() {
        this.otherData = new VdfOtherData(this.questions);
    ...
    setValuesForDateInputs() {
        this.dateData = new VdfDateDate(this.questions);
