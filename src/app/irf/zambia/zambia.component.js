...
export class IrfZambiaController extends BaseIrfBlindVerificationController {
    constructor($scope, $uibModal, constants, IrfService, $stateParams, $state, SpinnerOverlayService, $uibModalStack, SessionService) {
        ...
        this.vulnerabilityQuestions = ["vulnerableLabel",1084,1073,502,925,78,942,926,280,974,1083,1070,1071,1072];
        ...
        this.details = {
            ...
            245.2:{
                enabled:true,
                group:245,
                label:'Chinotimba, Zimbabwe',
                value: 'Chinotimba, Zimbabwe',
                type:'checkbox-group',
                format:'col-md-6',
                points:0
            },
...
export default {
    templateUrl,
    controller: IrfZambiaController,
};
